            ...
            $payload['payment'] = [
                'banking_billet' => [
                    'customer' => [
                        ...
                        'cpf' => preg_replace('/\D/', '', $subscriptionData['customer_cpf']),
                        'email' => $subscriptionData['customer_email'],
                        'phone_number' => preg_replace('/\D/', '', $subscriptionData['customer_phone']),
                        'address' => [
                            ...
                            'zipcode' => preg_replace('/\D/', '', $subscriptionData['customer_address']['zipcode']),
